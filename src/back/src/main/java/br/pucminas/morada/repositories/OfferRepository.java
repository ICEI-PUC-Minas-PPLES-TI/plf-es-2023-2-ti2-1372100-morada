...
public interface OfferRepository extends JpaRepository<Offer, Long>, JpaSpecificationExecutor<Offer>{
    ...
    @Query(value = "SELECT p.photo_base64, p.street, p.id, p.type, o.rent_value, o.id FROM offer o JOIN property p ON o.property_id = p.id WHERE o.user_id = :user_id", nativeQuery = true)
    List<Map<String, Object>> findAllOffersFromUser(@Param("user_id") Long user_id);
